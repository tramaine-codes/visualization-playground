import{r as De,u as En,R as Ue,j as L,S as fe,B as Y,C as Fe,a as ve,b as gn,_ as pn,F as Rn,T as $,c as Dn,s as On}from"./index-PwdbsfB5.js";function je(e,n){const[t,i]=De.useState({status:"not-executed",error:void 0,result:n}),a=De.useRef(),s=De.useRef(),l=En({execute(...T){s.current=T;const c=e(...T);return a.current=c,i(r=>({...r,status:"loading"})),c.then(r=>{c===a.current&&i(o=>({...o,status:"success",error:void 0,result:r}))},r=>{c===a.current&&i(o=>({...o,status:"error",error:r}))}),c},reset(){i({status:"not-executed",error:void 0,result:n}),a.current=void 0,s.current=void 0}});return[t,De.useMemo(()=>({reset(){l.current.reset()},execute:(...T)=>l.current.execute(...T)}),[]),{promise:a.current,lastArgs:s.current}]}function Bn(e){switch(e){case"index":return`direction: down
...
Customer -> BigbankInternetBankingSystem.MobileApp: "Views account balances, and makes payments using"
BigbankInternetBankingSystem.MobileApp -> BigbankInternetBankingSystem.ApiApplication.ResetPasswordController: "Makes API calls to\\r [JSON/HTTPS]"
BigbankInternetBankingSystem.MobileApp -> BigbankInternetBankingSystem.ApiApplication.AccountsSummaryController: "Makes API calls to\\r [JSON/HTTPS]"
BigbankInternetBankingSystem.MobileApp -> BigbankInternetBankingSystem.ApiApplication.SigninController: "Makes API calls to\\r [JSON/HTTPS]"
`;default:throw new Error("Unknown viewId: "+e)}}const{createElement:Le,createContext:In,createRef:qn,forwardRef:Ke,useCallback:J,useContext:qe,useEffect:se,useImperativeHandle:Ye,useLayoutEffect:mn,useMemo:An,useRef:j,useState:ke}=Ue,Ve=Ue.useId,ue=In(null);ue.displayName="PanelGroupContext";const me=mn,dn=typeof Ve=="function"?Ve:()=>null;let bn=0;function we(e=null){const n=dn(),t=j(e||n||null);return t.current===null&&(t.current=""+bn++),e??t.current}function $e({children:e,className:n="",collapsedSizePercentage:t,collapsedSizePixels:i,collapsible:a,dataAttributes:s,defaultSizePercentage:l,defaultSizePixels:T,forwardedRef:c,id:r,maxSizePercentage:o,maxSizePixels:E,minSizePercentage:g,minSizePixels:f,onCollapse:p,onExpand:u,onResize:S,order:m,style:k,tagName:H="div"}){const z=qe(ue);if(z===null)throw Error("Panel components must be rendered within a PanelGroup container");const{collapsePanel:A,expandPanel:I,getPanelSize:v,getPanelStyle:X,groupId:w,isPanelCollapsed:M,registerPanel:re,resizePanel:_,unregisterPanel:Q}=z,ee=we(r),V=j({callbacks:{onCollapse:p,onExpand:u,onResize:S},constraints:{collapsedSizePercentage:t,collapsedSizePixels:i,collapsible:a,defaultSizePercentage:l,defaultSizePixels:T,maxSizePercentage:o,maxSizePixels:E,minSizePercentage:g,minSizePixels:f},id:ee,idIsFromProps:r!==void 0,order:m});j({didLogMissingDefaultSizeWarning:!1}),me(()=>{const{callbacks:K,constraints:Z}=V.current;V.current.id=ee,V.current.idIsFromProps=r!==void 0,V.current.order=m,K.onCollapse=p,K.onExpand=u,K.onResize=S,Z.collapsedSizePercentage=t,Z.collapsedSizePixels=i,Z.collapsible=a,Z.defaultSizePercentage=l,Z.defaultSizePixels=T,Z.maxSizePercentage=o,Z.maxSizePixels=E,Z.minSizePercentage=g,Z.minSizePixels=f}),me(()=>{const K=V.current;return re(K),()=>{Q(K)}},[m,ee,re,Q]),Ye(c,()=>({collapse:()=>{A(V.current)},expand:()=>{I(V.current)},getId(){return ee},getSize(){return v(V.current)},isCollapsed(){return M(V.current)},isExpanded(){return!M(V.current)},resize:K=>{_(V.current,K)}}),[A,I,v,M,ee,_]);const de=X(V.current);return Le(H,{children:e,className:n,style:{...de,...k},...s,"data-panel":"","data-panel-id":ee,"data-panel-group-id":w,"data-panel-collapsible":void 0,"data-panel-size":void 0})}const le=Ke((e,n)=>Le($e,{...e,forwardedRef:n}));$e.displayName="Panel";le.displayName="forwardRef(Panel)";function Oe(e,n){return e/n*100}function Ze(e,n){let{collapsedSizePercentage:t=0,collapsedSizePixels:i,defaultSizePercentage:a,defaultSizePixels:s,maxSizePercentage:l=100,maxSizePixels:T,minSizePercentage:c=0,minSizePixels:r}=e;return(i!=null||s!=null||r!=null||T!=null)&&n<=0?(console.warn(`WARNING: Invalid group size: ${n}px`),{collapsedSizePercentage:0,defaultSizePercentage:a,maxSizePercentage:0,minSizePercentage:0}):(i!=null&&(t=Oe(i,n)),s!=null&&(a=Oe(s,n)),r!=null&&(c=Oe(r,n)),T!=null&&(l=Oe(T,n)),{collapsedSizePercentage:t,defaultSizePercentage:a,maxSizePercentage:l,minSizePercentage:c})}function Ee(e,n,t){let i=0,a=0;for(let r=0;r<e.length;r++)if(r!==n){const{collapsible:o}=e[r],{collapsedSizePercentage:E,maxSizePercentage:g,minSizePercentage:f}=Ze(e[r],t);a+=g,i+=o?E:f}const{collapsedSizePercentage:s,defaultSizePercentage:l,maxSizePercentage:T,minSizePercentage:c}=Ze(e[n],t);return{collapsedSizePercentage:s,defaultSizePercentage:l,maxSizePercentage:e.length>1?Math.min(T,100-i):T,minSizePercentage:e.length>1?Math.max(c,100-a):c}}const Nn=10;function Ae(e,n,t=Nn){e=parseFloat(e.toFixed(t)),n=parseFloat(n.toFixed(t));const i=e-n;return i===0?0:i>0?1:-1}function U(e,n,t){return Ae(e,n,t)===0}function ce({groupSizePixels:e,panelConstraints:n,panelIndex:t,size:i}){if(n.some(({collapsedSizePixels:r,defaultSizePixels:o,minSizePixels:E,maxSizePixels:g})=>r!=null||o!=null||E!=null||g!=null)&&e<=0)return console.warn(`WARNING: Invalid group size: ${e}px`),0;let{collapsible:s}=n[t];const{collapsedSizePercentage:l,maxSizePercentage:T,minSizePercentage:c}=Ee(n,t,e);if(c!=null&&Ae(i,c)<0)if(s){const r=(l+c)/2;Ae(i,r)<0?i=l:i=c}else i=c;return T!=null&&(i=Math.min(T,i)),i}function Be({delta:e,groupSizePixels:n,layout:t,panelConstraints:i,pivotIndices:a,trigger:s}){if(U(e,0))return t;const l=[...t];let T=0;if(s==="keyboard"){{const r=e<0?a[1]:a[0];if(i[r].collapsible){const E=t[r],{collapsedSizePercentage:g,minSizePercentage:f}=Ee(i,r,n);if(U(E,g)){const p=f-E;Ae(p,Math.abs(e))>0&&(e=e<0?0-p:p)}}}{const r=e<0?a[0]:a[1];if(i[r].collapsible){const E=t[r],{collapsedSizePercentage:g,minSizePercentage:f}=Ee(i,r,n);if(U(E,f)){const p=E-g;Ae(p,Math.abs(e))>0&&(e=e<0?0-p:p)}}}}{const r=e<0?1:-1;let o=e<0?a[1]:a[0],E=0;for(;;){const f=t[o],u=ce({groupSizePixels:n,panelConstraints:i,panelIndex:o,size:100})-f;if(E+=u,o+=r,o<0||o>=i.length)break}const g=Math.min(Math.abs(e),Math.abs(E));e=e<0?0-g:g}{let o=e<0?a[0]:a[1];for(;o>=0&&o<i.length;){const E=Math.abs(e)-Math.abs(T),g=t[o],f=g-E,p=ce({groupSizePixels:n,panelConstraints:i,panelIndex:o,size:f});if(!U(g,p)&&(T+=g-p,l[o]=p,T.toPrecision(3).localeCompare(Math.abs(e).toPrecision(3),void 0,{numeric:!0})>=0))break;e<0?o--:o++}}if(U(T,0))return t;{const r=e<0?a[1]:a[0],o=t[r]+T,E=ce({groupSizePixels:n,panelConstraints:i,panelIndex:r,size:o});if(l[r]=E,!U(E,o)){let g=o-E,p=e<0?a[1]:a[0];for(;p>=0&&p<i.length;){const u=l[p],S=u+g,m=ce({groupSizePixels:n,panelConstraints:i,panelIndex:p,size:S});if(U(u,m)||(g-=m-u,l[p]=m),U(g,0))break;e>0?p--:p++}}}const c=l.reduce((r,o)=>o+r,0);return T=100-c,U(c,100)?l:t}function Xe(e,n="Assertion failed!"){if(!e)throw console.error(n),Error(n)}function ie({sizePercentage:e,sizePixels:n},t){if(e!=null)return e;if(n!=null)return Oe(n,t)}function Cn({groupSizePixels:e,layout:n,panelsArray:t,pivotIndices:i}){let a=0,s=100,l=0,T=0;t.forEach((E,g)=>{var f,p;const{constraints:u}=E,{maxSizePercentage:S,maxSizePixels:m,minSizePercentage:k,minSizePixels:H}=u,z=(f=ie({sizePercentage:k,sizePixels:H},e))!==null&&f!==void 0?f:0,A=(p=ie({sizePercentage:S,sizePixels:m},e))!==null&&p!==void 0?p:100;g===i[0]?(a=z,s=A):(l+=z,T+=A)});const c=Math.min(s,100-l),r=Math.max(a,100-T),o=n[i[0]];return{valueMax:c,valueMin:r,valueNow:o}}function oe(e){return Array.from(document.querySelectorAll(`[data-panel-resize-handle-id][data-panel-group-id="${e}"]`))}function Qe(e,n){const i=oe(e).findIndex(a=>a.getAttribute("data-panel-resize-handle-id")===n);return i??null}function en(e,n){const t=Qe(e,n);return t!=null?[t,t+1]:[-1,-1]}function ge(e){const n=document.querySelector(`[data-panel-group][data-panel-group-id="${e}"]`);return n||null}function ne(e){const n=ge(e);if(n==null)return NaN;const t=n.getAttribute("data-panel-group-direction"),i=oe(e);return t==="horizontal"?n.offsetWidth-i.reduce((a,s)=>a+s.offsetWidth,0):n.offsetHeight-i.reduce((a,s)=>a+s.offsetHeight,0)}function Sn(e){const n=ge(e);if(n==null)return NaN;const t=n.getAttribute("data-panel-group-direction"),i=oe(e);return t==="horizontal"?n.offsetWidth-i.reduce((a,s)=>a+s.offsetWidth,0):n.offsetHeight-i.reduce((a,s)=>a+s.offsetHeight,0)}function ye(e){const n=document.querySelector(`[data-panel-resize-handle-id="${e}"]`);return n||null}function kn(e,n,t){var i,a,s,l;const T=ye(n),c=oe(e),r=T?c.indexOf(T):-1,o=(i=(a=t[r])===null||a===void 0?void 0:a.id)!==null&&i!==void 0?i:null,E=(s=(l=t[r+1])===null||l===void 0?void 0:l.id)!==null&&s!==void 0?s:null;return[o,E]}function un({committedValuesRef:e,eagerValuesRef:n,groupId:t,layout:i,panelDataArray:a,setLayout:s}){j({didWarnAboutMissingResizeHandle:!1}),me(()=>{const l=ne(t),T=oe(t);for(let c=0;c<a.length-1;c++){const{valueMax:r,valueMin:o,valueNow:E}=Cn({groupSizePixels:l,layout:i,panelsArray:a,pivotIndices:[c,c+1]}),g=T[c];g==null||(g.setAttribute("aria-controls",a[c].id),g.setAttribute("aria-valuemax",""+Math.round(r)),g.setAttribute("aria-valuemin",""+Math.round(o)),g.setAttribute("aria-valuenow",""+Math.round(E)))}return()=>{T.forEach((c,r)=>{c.removeAttribute("aria-controls"),c.removeAttribute("aria-valuemax"),c.removeAttribute("aria-valuemin"),c.removeAttribute("aria-valuenow")})}},[t,i,a]),se(()=>{const{panelDataArray:l}=n.current,T=ge(t);Xe(T!=null,`No group found for id "${t}"`);const r=oe(t).map(o=>{const E=o.getAttribute("data-panel-resize-handle-id"),[g,f]=kn(t,E,l);if(g==null||f==null)return()=>{};const p=u=>{if(!u.defaultPrevented)switch(u.key){case"Enter":{u.preventDefault();const k=l.findIndex(H=>H.id===g);if(k>=0){const H=l[k],z=i[k];if(z!=null&&H.constraints.collapsible){var S,m;const A=Sn(t),I=(S=ie({sizePercentage:H.constraints.collapsedSizePercentage,sizePixels:H.constraints.collapsedSizePixels},A))!==null&&S!==void 0?S:0,v=(m=ie({sizePercentage:H.constraints.minSizePercentage,sizePixels:H.constraints.minSizePixels},A))!==null&&m!==void 0?m:0,X=Be({delta:U(z,I)?v-I:I-z,groupSizePixels:A,layout:i,panelConstraints:l.map(w=>w.constraints),pivotIndices:en(t,E),trigger:"keyboard"});i!==X&&s(X)}}break}}};return o.addEventListener("keydown",p),()=>{o.removeEventListener("keydown",p)}});return()=>{r.forEach(o=>o())}},[e,n,t,i,a,s])}function Ne(e,n){if(e.length!==n.length)return!1;for(let t=0;t<e.length;t++)if(e[t]!==n[t])return!1;return!0}function nn(e){return e.type==="keydown"}function tn(e){return e.type.startsWith("mouse")}function an(e){return e.type.startsWith("touch")}function sn(e,n){const t=e==="horizontal";if(tn(n))return t?n.clientX:n.clientY;if(an(n)){const i=n.touches[0];return t?i.screenX:i.screenY}else throw Error(`Unsupported event type "${n.type}"`)}function yn(e,n,t,i){const a=t==="horizontal",l=ye(n).getAttribute("data-panel-group-id");let{initialCursorPosition:T}=i;const c=sn(t,e),o=ge(l).getBoundingClientRect(),E=a?o.width:o.height;return(c-T)/E*100}function xn(e,n,t,i,a,s){if(nn(e)){const l=i==="horizontal",c=ge(n).getBoundingClientRect(),r=l?c.width:c.height;let o=0;e.shiftKey?o=100:s.percentage!=null?o=s.percentage:s.pixels!=null?o=s.pixels/r:o=10;let E=0;switch(e.key){case"ArrowDown":E=l?0:o;break;case"ArrowLeft":E=l?-o:0;break;case"ArrowRight":E=l?o:0;break;case"ArrowUp":E=l?0:-o;break;case"End":E=100;break;case"Home":E=-100;break}return E}else return yn(e,t,i,a)}function _e({groupSizePixels:e,panelDataArray:n}){const t=Array(n.length),i=n.map(l=>l.constraints);let a=0,s=100;for(let l=0;l<n.length;l++){const{defaultSizePercentage:T}=Ee(i,l,e);T!=null&&(a++,t[l]=T,s-=T)}for(let l=0;l<n.length;l++){const{defaultSizePercentage:T}=Ee(i,l,e);if(T!=null)continue;const c=n.length-a,r=s/c;a++,t[l]=r,s-=r}return t}function q(e,n){return e/100*n}function te(e,n,t,i){const a=ne(e);t.forEach((s,l)=>{const T=n[l];if(!T)return;const{callbacks:c,constraints:r,id:o}=T,{collapsible:E}=r,g={sizePercentage:s,sizePixels:q(s,a)},f=i[o];if(f==null||g.sizePercentage!==f.sizePercentage||g.sizePixels!==f.sizePixels){i[o]=g;const{onCollapse:u,onExpand:S,onResize:m}=c;if(m&&m(g,f),E&&(u||S)){var p;const k=(p=ie({sizePercentage:r.collapsedSizePercentage,sizePixels:r.collapsedSizePixels},a))!==null&&p!==void 0?p:0,H=ie(g,a);S&&(f==null||f.sizePercentage===k)&&H!==k&&S(),u&&(f==null||f.sizePercentage!==k)&&H===k&&u()}}})}function Ce(e,n){if(e.length!==n.length)return!1;for(let t=0;t<e.length;t++)if(e[t]!=n[t])return!1;return!0}function Pn({dragState:e,layout:n,panelData:t,panelIndex:i,precision:a=3}){const s=n[i];let l;return t.length===1||s==null?l="1":l=s.toPrecision(a),{flexBasis:0,flexGrow:l,flexShrink:1,overflow:"hidden",pointerEvents:e!==null?"none":void 0}}let He=null,ae=null;function ln(e){switch(e){case"horizontal":return"ew-resize";case"horizontal-max":return"w-resize";case"horizontal-min":return"e-resize";case"vertical":return"ns-resize";case"vertical-max":return"n-resize";case"vertical-min":return"s-resize"}}function hn(){ae!==null&&(document.head.removeChild(ae),He=null,ae=null)}function he(e){if(He===e)return;He=e;const n=ln(e);ae===null&&(ae=document.createElement("style"),document.head.appendChild(ae)),ae.innerHTML=`*{cursor: ${n}!important;}`}function Gn(e,n=10){let t=null;return(...a)=>{t!==null&&clearTimeout(t),t=setTimeout(()=>{e(...a)},n)}}function Hn(e){return Array.from(document.querySelectorAll(`[data-panel][data-panel-group-id="${e}"]`))}function We(e){try{if(typeof localStorage<"u")e.getItem=n=>localStorage.getItem(n),e.setItem=(n,t)=>{localStorage.setItem(n,t)};else throw new Error("localStorage not supported in this environment")}catch(n){console.error(n),e.getItem=()=>null,e.setItem=()=>{}}}function on(e){return e.map(n=>{const{constraints:t,id:i,idIsFromProps:a,order:s}=n;return a?i:`${s}:${JSON.stringify(t)}`}).sort((n,t)=>n.localeCompare(t)).join(",")}function rn(e,n){try{const t=n.getItem(`PanelGroup:sizes:${e}`);if(t){const i=JSON.parse(t);if(typeof i=="object"&&i!=null)return i}}catch{}return null}function Fn(e,n,t){const i=rn(e,t);if(i){var a;const s=on(n);return(a=i[s])!==null&&a!==void 0?a:null}return null}function vn(e,n,t,i){const a=on(n),s=rn(e,i)||{};s[a]=t;try{i.setItem(`PanelGroup:sizes:${e}`,JSON.stringify(s))}catch(l){console.error(l)}}function Je(e){return e.some(n=>n.collapsedSizePixels!==void 0||n.maxSizePixels!==void 0||n.minSizePixels!==void 0)}function Se({groupSizePixels:e,layout:n,panelConstraints:t}){const i=[...n];if(i.length!==t.length)throw Error(`Invalid ${t.length} panel layout: ${i.map(s=>`${s}%`).join(", ")}`);U(i.reduce((s,l)=>s+l,0),100);let a=0;for(let s=0;s<t.length;s++){const l=i[s],T=ce({groupSizePixels:e,panelConstraints:t,panelIndex:s,size:l});l!=T&&(a+=l-T,i[s]=T)}if(!U(a,0))for(let s=0;s<t.length;s++){const l=i[s],T=l+a,c=ce({groupSizePixels:e,panelConstraints:t,panelIndex:s,size:T});if(l!==c&&(a-=c-l,i[s]=c,U(a,0)))break}return i}const wn=100,Ie={getItem:e=>(We(Ie),Ie.getItem(e)),setItem:(e,n)=>{We(Ie),Ie.setItem(e,n)}},Ge={};function Tn({autoSaveId:e=null,children:n,className:t="",dataAttributes:i,direction:a,forwardedRef:s,id:l,onLayout:T=null,keyboardResizeByPercentage:c=null,keyboardResizeByPixels:r=null,storage:o=Ie,style:E,tagName:g="div"}){const f=we(l),[p,u]=ke(null),[S,m]=ke([]),k=j({}),H=j(new Map),z=j(0),A=j({autoSaveId:e,direction:a,dragState:p,id:f,keyboardResizeByPercentage:c,keyboardResizeByPixels:r,onLayout:T,storage:o}),I=j({layout:S,panelDataArray:[]});j({didLogIdAndOrderWarning:!1,didLogPanelConstraintsWarning:!1,prevPanelIds:[]}),Ye(s,()=>({getId:()=>A.current.id,getLayout:()=>{const{id:R}=A.current,{layout:d}=I.current,O=ne(R);return d.map(D=>({sizePercentage:D,sizePixels:q(D,O)}))},setLayout:R=>{const{id:d,onLayout:O}=A.current,{layout:D,panelDataArray:B}=I.current,N=ne(d),b=R.map(y=>ie(y,N)),x=Se({groupSizePixels:N,layout:b,panelConstraints:B.map(y=>y.constraints)});Ne(D,x)||(m(x),I.current.layout=x,O&&O(x.map(y=>({sizePercentage:y,sizePixels:q(y,N)}))),te(d,B,x,k.current))}}),[]),me(()=>{A.current.autoSaveId=e,A.current.direction=a,A.current.dragState=p,A.current.id=f,A.current.onLayout=T,A.current.storage=o}),un({committedValuesRef:A,eagerValuesRef:I,groupId:f,layout:S,panelDataArray:I.current.panelDataArray,setLayout:m}),se(()=>{const{panelDataArray:R}=I.current;if(e){if(S.length===0||S.length!==R.length)return;Ge[e]||(Ge[e]=Gn(vn,wn)),Ge[e](e,R,S,o)}},[e,S,o]),me(()=>{const{layout:R,panelDataArray:d}=I.current,O=d.map(({constraints:D})=>D);if(Je(O))if(typeof ResizeObserver>"u")console.warn("WARNING: Pixel based constraints require ResizeObserver but it is not supported by the current browser.");else{const D=new ResizeObserver(()=>{const B=ne(f),{onLayout:N}=A.current,b=Se({groupSizePixels:B,layout:R,panelConstraints:d.map(x=>x.constraints)});Ne(R,b)||(m(b),I.current.layout=b,N&&N(b.map(x=>({sizePercentage:x,sizePixels:q(x,B)}))),te(f,d,b,k.current))});return D.observe(ge(f)),()=>{D.disconnect()}}},[f]),se(()=>{});const v=J(R=>{const{onLayout:d}=A.current,{layout:O,panelDataArray:D}=I.current;if(R.constraints.collapsible){const B=D.map(G=>G.constraints),{collapsedSizePercentage:N,panelSizePercentage:b,pivotIndices:x,groupSizePixels:y}=Te(f,D,R,O);if(b!==N){H.current.set(R.id,b);const F=D.indexOf(R)===D.length-1?b-N:N-b,C=Be({delta:F,groupSizePixels:y,layout:O,panelConstraints:B,pivotIndices:x,trigger:"imperative-api"});Ce(O,C)||(m(C),I.current.layout=C,d&&d(C.map(P=>({sizePercentage:P,sizePixels:q(P,y)}))),te(f,D,C,k.current))}}},[f]),X=J(R=>{const{onLayout:d}=A.current,{layout:O,panelDataArray:D}=I.current;if(R.constraints.collapsible){const B=D.map(F=>F.constraints),{collapsedSizePercentage:N,panelSizePercentage:b,minSizePercentage:x,pivotIndices:y,groupSizePixels:G}=Te(f,D,R,O);if(b===N){const F=H.current.get(R.id),C=F!=null&&F>=x?F:x,h=D.indexOf(R)===D.length-1?b-C:C-b,W=Be({delta:h,groupSizePixels:G,layout:O,panelConstraints:B,pivotIndices:y,trigger:"imperative-api"});Ce(O,W)||(m(W),I.current.layout=W,d&&d(W.map(pe=>({sizePercentage:pe,sizePixels:q(pe,G)}))),te(f,D,W,k.current))}}},[f]),w=J(R=>{const{layout:d,panelDataArray:O}=I.current,{panelSizePercentage:D,panelSizePixels:B}=Te(f,O,R,d);return{sizePercentage:D,sizePixels:B}},[f]),M=J(R=>{const{panelDataArray:d}=I.current,O=d.indexOf(R);return Pn({dragState:p,layout:S,panelData:d,panelIndex:O})},[p,S]),re=J(R=>{const{layout:d,panelDataArray:O}=I.current,{collapsedSizePercentage:D,collapsible:B,panelSizePercentage:N}=Te(f,O,R,d);return B===!0&&N===D},[f]),_=J(R=>{const{layout:d,panelDataArray:O}=I.current,{collapsedSizePercentage:D,collapsible:B,panelSizePercentage:N}=Te(f,O,R,d);return!B||N>D},[f]),Q=J(R=>{const{autoSaveId:d,id:O,onLayout:D,storage:B}=A.current,{layout:N,panelDataArray:b}=I.current;if(b.push(R),b.sort((C,P)=>{const h=C.order,W=P.order;return h==null&&W==null?0:h==null?-1:W==null?1:h-W}),Hn(O).length!==b.length)return;let y=null;d&&(y=Fn(d,b,B));const G=ne(O);if(G<=0&&Je(b.map(({constraints:C})=>C)))return;y==null&&(y=_e({groupSizePixels:G,panelDataArray:b}));const F=Se({groupSizePixels:G,layout:y,panelConstraints:b.map(C=>C.constraints)});m(F),I.current.layout=F,Ne(N,F)||(D&&D(F.map(C=>({sizePercentage:C,sizePixels:q(C,G)}))),te(O,b,F,k.current))},[]),ee=J(R=>function(O){O.preventDefault();const{direction:D,dragState:B,id:N,keyboardResizeByPercentage:b,keyboardResizeByPixels:x,onLayout:y}=A.current,{layout:G,panelDataArray:F}=I.current,{initialLayout:C}=B??{},P=en(N,R);let h=xn(O,N,R,D,B,{percentage:b,pixels:x});if(h===0)return;const W=D==="horizontal";document.dir==="rtl"&&W&&(h=-h);const pe=ne(N),Ln=F.map(be=>be.constraints),Re=Be({delta:h,groupSizePixels:pe,layout:C??G,panelConstraints:Ln,pivotIndices:P,trigger:nn(O)?"keyboard":"mouse-or-touch"}),ze=!Ce(G,Re);(tn(O)||an(O))&&z.current!=h&&(z.current=h,he(ze?W?"horizontal":"vertical":W?h<0?"horizontal-min":"horizontal-max":h<0?"vertical-min":"vertical-max")),ze&&(m(Re),I.current.layout=Re,y&&y(Re.map(be=>({sizePercentage:be,sizePixels:q(be,pe)}))),te(N,F,Re,k.current))},[]),V=J((R,d)=>{const{onLayout:O}=A.current,{layout:D,panelDataArray:B}=I.current,N=B.map(h=>h.constraints),{groupSizePixels:b,panelSizePercentage:x,pivotIndices:y}=Te(f,B,R,D),G=ie(d,b),C=B.indexOf(R)===B.length-1?x-G:G-x,P=Be({delta:C,groupSizePixels:b,layout:D,panelConstraints:N,pivotIndices:y,trigger:"imperative-api"});Ce(D,P)||(m(P),I.current.layout=P,O&&O(P.map(h=>({sizePercentage:h,sizePixels:q(h,b)}))),te(f,B,P,k.current))},[f]),de=J((R,d)=>{const{direction:O}=A.current,{layout:D}=I.current,B=ye(R),N=sn(O,d);u({dragHandleId:R,dragHandleRect:B.getBoundingClientRect(),initialCursorPosition:N,initialLayout:D})},[]),K=J(()=>{hn(),u(null)},[]),Z=j({pendingPanelIds:new Set,timeout:null}),Me=J(R=>{const{id:d,onLayout:O}=A.current,{layout:D,panelDataArray:B}=I.current,N=B.indexOf(R);N>=0&&(B.splice(N,1),Z.current.pendingPanelIds.add(R.id)),Z.current.timeout!=null&&clearTimeout(Z.current.timeout),Z.current.timeout=setTimeout(()=>{const{pendingPanelIds:b}=Z.current,x=k.current;let y=!1;if(b.forEach(P=>{b.delete(P),B.find(({id:h})=>h===P)==null&&(y=!0,delete x[R.id])}),!y||B.length===0)return;const G=ne(d);let F=_e({groupSizePixels:G,panelDataArray:B});const C=Se({groupSizePixels:G,layout:F,panelConstraints:B.map(P=>P.constraints)});Ne(D,C)||(m(C),I.current.layout=C,O&&O(C.map(P=>({sizePercentage:P,sizePixels:q(P,G)}))),te(d,B,C,k.current))},0)},[]),cn=An(()=>({collapsePanel:v,direction:a,dragState:p,expandPanel:X,getPanelSize:w,getPanelStyle:M,groupId:f,isPanelCollapsed:re,isPanelExpanded:_,registerPanel:Q,registerResizeHandle:ee,resizePanel:V,startDragging:de,stopDragging:K,unregisterPanel:Me}),[v,p,a,X,w,M,f,re,_,Q,ee,V,de,K,Me]),fn={display:"flex",flexDirection:a==="horizontal"?"row":"column",height:"100%",overflow:"hidden",width:"100%"};return Le(ue.Provider,{value:cn},Le(g,{children:n,className:t,style:{...fn,...E},...i,"data-panel-group":"","data-panel-group-direction":a,"data-panel-group-id":f}))}const xe=Ke((e,n)=>Le(Tn,{...e,forwardedRef:n}));Tn.displayName="PanelGroup";xe.displayName="forwardRef(PanelGroup)";function Te(e,n,t,i){const a=n.map(f=>f.constraints),s=n.indexOf(t),l=a[s],T=ne(e),c=Ee(a,s,T),o=s===n.length-1?[s-1,s]:[s,s+1],E=i[s],g=q(E,T);return{...c,collapsible:l.collapsible,panelSizePercentage:E,panelSizePixels:g,groupSizePixels:T,pivotIndices:o}}function Mn({disabled:e,handleId:n,resizeHandler:t}){se(()=>{if(e||t==null)return;const i=ye(n);if(i==null)return;const a=s=>{if(!s.defaultPrevented)switch(s.key){case"ArrowDown":case"ArrowLeft":case"ArrowRight":case"ArrowUp":case"End":case"Home":{s.preventDefault(),t(s);break}case"F6":{s.preventDefault();const l=i.getAttribute("data-panel-group-id"),T=oe(l),c=Qe(l,n);Xe(c!==null);const r=s.shiftKey?c>0?c-1:T.length-1:c+1<T.length?c+1:0;T[r].focus();break}}};return i.addEventListener("keydown",a),()=>{i.removeEventListener("keydown",a)}},[e,n,t])}function Pe({children:e=null,className:n="",dataAttributes:t,disabled:i=!1,id:a=null,onDragging:s,style:l={},tagName:T="div"}){const c=j(null),r=j({onDragging:s});se(()=>{r.current.onDragging=s});const o=qe(ue);if(o===null)throw Error("PanelResizeHandle components must be rendered within a PanelGroup container");const{direction:E,dragState:g,groupId:f,registerResizeHandle:p,startDragging:u,stopDragging:S}=o,m=we(a),k=(g==null?void 0:g.dragHandleId)===m,[H,z]=ke(!1),[A,I]=ke(null),v=J(()=>{c.current.blur(),S();const{onDragging:M}=r.current;M&&M(!1)},[S]);se(()=>{if(i)I(null);else{const w=p(m);I(()=>w)}},[i,m,p]),se(()=>{if(i||A==null||!k)return;const w=Q=>{A(Q)},M=Q=>{A(Q)},_=c.current.ownerDocument;return _.body.addEventListener("contextmenu",v),_.body.addEventListener("mousemove",w),_.body.addEventListener("touchmove",w),_.body.addEventListener("mouseleave",M),window.addEventListener("mouseup",v),window.addEventListener("touchend",v),()=>{_.body.removeEventListener("contextmenu",v),_.body.removeEventListener("mousemove",w),_.body.removeEventListener("touchmove",w),_.body.removeEventListener("mouseleave",M),window.removeEventListener("mouseup",v),window.removeEventListener("touchend",v)}},[E,i,k,A,v]),Mn({disabled:i,handleId:m,resizeHandler:A});const X={cursor:ln(E),touchAction:"none",userSelect:"none"};return Le(T,{children:e,className:n,onBlur:()=>z(!1),onFocus:()=>z(!0),onMouseDown:w=>{u(m,w.nativeEvent);const{onDragging:M}=r.current;M&&M(!0)},onMouseUp:v,onTouchCancel:v,onTouchEnd:v,onTouchStart:w=>{u(m,w.nativeEvent);const{onDragging:M}=r.current;M&&M(!0)},ref:c,role:"separator",style:{...X,...l},tabIndex:0,...t,"data-panel-group-direction":E,"data-panel-group-id":f,"data-resize-handle":"","data-resize-handle-active":k?"pointer":H?"keyboard":void 0,"data-panel-resize-handle-enabled":!i,"data-panel-resize-handle-id":m})}Pe.displayName="PanelResizeHandle";const zn=async e=>await(await fetch("https://kroki.io/d2/svg",{method:"POST",cache:"force-cache",body:JSON.stringify({diagram_source:e,output_format:"svg"}),headers:{"Content-Type":"application/json"}})).text();function Vn({viewId:e}){var a;const n=Bn(e),[t,{execute:i}]=je(zn,null);return L.jsxs(xe,{direction:"horizontal",autoSaveId:"ViewAsD2",children:[L.jsx(le,{minSizePixels:100,children:L.jsxs(fe,{scrollbars:"both",children:[L.jsx(Y,{asChild:!0,display:"block",p:"2",style:{whiteSpace:"pre",minHeight:"100%"},children:L.jsx(Fe,{variant:"soft",autoFocus:!0,children:n})}),L.jsx(ve,{text:n})]})}),L.jsx(Pe,{style:{width:10}}),L.jsx(le,{minSizePixels:100,children:L.jsxs(fe,{scrollbars:"both",children:[t.status!=="success"&&L.jsxs(L.Fragment,{children:[L.jsx(gn,{disabled:t.status==="loading",onClick:()=>void i(n),children:t.status==="loading"?"Loading...":"Render with Kroki"}),t.status==="error"&&L.jsx(Y,{children:(a=t.error)==null?void 0:a.message})]}),t.status==="success"&&L.jsx(Y,{grow:"1",asChild:!0,className:"svg-container",children:t.result?L.jsx("div",{dangerouslySetInnerHTML:{__html:t.result}}):L.jsx(Y,{children:"Empty result"})})]})})]})}function Zn(e){switch(e){case"index":return`digraph {
    graph [TBbalance=min,
        bgcolor=transparent,
        compound=true,
        fontname=Helvetica,
...
<!-- Generated by graphviz version 9.0.0 (0)
 -->
<!-- Pages: 1 -->
<svg width="795pt" height="910pt"
 viewBox="0.00 0.00 795.30 910.00" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
<g id="graph0" class="graph" transform="scale(1 1) rotate(0) translate(4 906)">
<g id="clust1" class="cluster">
<title>cluster_internetbankingsystem</title>
<polygon fill="#3e4651" stroke="#2d333d" points="8,-8 8,-894 425,-894 425,-8 8,-8"/>
<text text-anchor="start" x="16" y="-879.3" font-family="Helvetica,sans-Serif" font-weight="bold" font-size="13.00" fill="#cbd5e1" fill-opacity="0.701961">INTERNET BANKING SYSTEM</text>
</g>
<!-- webapplication -->
<g id="node1" class="node">
<title>webapplication</title>
<polygon fill="#0284c7" stroke="#2563eb" stroke-width="0" points="364.19,-838.4 39.81,-838.4 39.81,-658.4 364.19,-658.4 364.19,-838.4"/>
<text text-anchor="start" x="129.74" y="-770.9" font-family="Helvetica,sans-Serif" font-size="20.00" fill="#f0f9ff">Web Application</text>
<text text-anchor="start" x="143.64" y="-749.1" font-family="Helvetica,sans-Serif" font-size="12.00" fill="#b6ecf7">Java and Spring MVC</text>
<text text-anchor="start" x="70.87" y="-727.9" font-family="Helvetica,sans-Serif" font-size="14.00" fill="#b6ecf7">Delivers the static content and the Internet</text>
<text text-anchor="start" x="102.37" y="-711.1" font-family="Helvetica,sans-Serif" font-size="14.00" fill="#b6ecf7">banking single page application.</text>
</g>
<!-- singlepageapplication -->
<g id="node2" class="node">
<title>singlepageapplication</title>
<polygon fill="#428a4f" stroke="#2563eb" stroke-width="0" points="366.02,-529.2 45.98,-529.2 45.98,-349.2 366.02,-349.2 366.02,-529.2"/>
<text text-anchor="start" x="99.82" y="-470.1" font-family="Helvetica,sans-Serif" font-size="20.00" fill="#f8fafc">Single&#45;Page Application</text>
<text text-anchor="start" x="143.96" y="-448.3" font-family="Helvetica,sans-Serif" font-size="12.00" fill="#c2f0c2">JavaScript and Angular</text>
<text text-anchor="start" x="98.21" y="-427.1" font-family="Helvetica,sans-Serif" font-size="14.00" fill="#c2f0c2">Provides all of the Internet banking</text>
<text text-anchor="start" x="85.78" y="-410.3" font-family="Helvetica,sans-Serif" font-size="14.00" fill="#c2f0c2">functionality to customers via their web</text>
<text text-anchor="start" x="179.16" y="-393.5" font-family="Helvetica,sans-Serif" font-size="14.00" fill="#c2f0c2">browser.</text>
</g>
<!-- apiapplication -->
<g id="node3" class="node">
<title>apiapplication</title>
...
<g id="node4" class="node">
<title>customer</title>
<polygon fill="#0284c7" stroke="#2563eb" stroke-width="0" points="787.3,-838.4 456.7,-838.4 456.7,-658.4 787.3,-658.4 787.3,-838.4"/>
<text text-anchor="start" x="497.49" y="-761.2" font-family="Helvetica,sans-Serif" font-size="20.00" fill="#f0f9ff">Personal Banking Customer</text>
<text text-anchor="start" x="487.76" y="-737.6" font-family="Helvetica,sans-Serif" font-size="14.00" fill="#b6ecf7">A customer of the bank, with personal bank</text>
<text text-anchor="start" x="592.04" y="-720.8" font-family="Helvetica,sans-Serif" font-size="14.00" fill="#b6ecf7">accounts.</text>
</g>
<!-- webapplication&#45;&gt;singlepageapplication -->
<g id="edge1" class="edge">
<title>webapplication&#45;&gt;singlepageapplication</title>
<path fill="none" stroke="#6e6e6e" stroke-width="2" stroke-dasharray="5,2" d="M203.16,-658.55C203.63,-622.01 204.19,-579.49 204.68,-541.73"/>
<polygon fill="#6e6e6e" stroke="#6e6e6e" stroke-width="2" points="208.17,-542.19 204.8,-532.15 201.17,-542.1 208.17,-542.19"/>
<text text-anchor="start" x="215" y="-597.7" font-family="Helvetica,sans-Serif" font-size="13.00" fill="#c6c6c6">Delivers to the customer&#39;s web</text>
<text text-anchor="start" x="215" y="-582.1" font-family="Helvetica,sans-Serif" font-size="13.00" fill="#c6c6c6">browser</text>
</g>
<!-- singlepageapplication&#45;&gt;apiapplication -->
<g id="edge2" class="edge">
<title>singlepageapplication&#45;&gt;apiapplication</title>
<path fill="none" stroke="#6e6e6e" stroke-width="2" stroke-dasharray="5,2" d="M206,-349.35C206,-312.81 206,-270.29 206,-232.53"/>
<polygon fill="#6e6e6e" stroke="#6e6e6e" stroke-width="2" points="209.5,-232.95 206,-222.95 202.5,-232.95 209.5,-232.95"/>
<text text-anchor="start" x="216" y="-288.5" font-family="Helvetica,sans-Serif" font-size="13.00" fill="#c6c6c6">Makes API calls to</text>
<text text-anchor="start" x="216" y="-272.9" font-family="Helvetica,sans-Serif" font-size="13.00" fill="#c6c6c6">[JSON/HTTPS]</text>
</g>
<!-- customer&#45;&gt;singlepageapplication -->
<g id="edge3" class="edge">
<title>customer&#45;&gt;singlepageapplication</title>
<path fill="none" stroke="#6e6e6e" stroke-width="2" stroke-dasharray="5,2" d="M522.85,-658.4C490.24,-630.45 453.28,-600.13 418,-574.2 400.62,-561.42 382.02,-548.57 363.33,-536.15"/>
<polygon fill="#6e6e6e" stroke="#6e6e6e" stroke-width="2" points="365.44,-533.35 355.16,-530.77 361.58,-539.2 365.44,-533.35"/>
<text text-anchor="start" x="474" y="-597.7" font-family="Helvetica,sans-Serif" font-size="13.00" fill="#c6c6c6">Views account balances, and makes</text>
<text text-anchor="start" x="474" y="-582.1" font-family="Helvetica,sans-Serif" font-size="13.00" fill="#c6c6c6">payments using</text>
</g>
</g>
</svg>
...
<!-- Generated by graphviz version 9.0.0 (0)
 -->
<!-- Pages: 1 -->
<svg width="1320pt" height="916pt"
 viewBox="0.00 0.00 1320.00 915.60" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
<g id="graph0" class="graph" transform="scale(1 1) rotate(0) translate(4 911.6)">
<g id="clust1" class="cluster">
<title>cluster_internetbankingsystem</title>
<polygon fill="#3a404a" stroke="#292f37" points="8,-8 8,-635.4 1304,-635.4 1304,-8 8,-8"/>
<text text-anchor="start" x="16" y="-620.7" font-family="Helvetica,sans-Serif" font-weight="bold" font-size="13.00" fill="#cbd5e1" fill-opacity="0.701961">INTERNET BANKING SYSTEM</text>
</g>
<g id="clust2" class="cluster">
<title>cluster_apiapplication</title>
...
<g id="node4" class="node">
<title>mobileapp</title>
<polygon fill="#428a4f" stroke="#2563eb" stroke-width="0" points="811.96,-579.8 486.04,-579.8 486.04,-399.8 811.96,-399.8 811.96,-579.8"/>
<text text-anchor="start" x="598.97" y="-520.7" font-family="Helvetica,sans-Serif" font-size="20.00" fill="#f8fafc">Mobile App</text>
<text text-anchor="start" x="626.66" y="-498.9" font-family="Helvetica,sans-Serif" font-size="12.00" fill="#c2f0c2">Xamarin</text>
<text text-anchor="start" x="526.05" y="-477.7" font-family="Helvetica,sans-Serif" font-size="14.00" fill="#c2f0c2">Provides a limited subset of the Internet</text>
<text text-anchor="start" x="517.1" y="-460.9" font-family="Helvetica,sans-Serif" font-size="14.00" fill="#c2f0c2">banking functionality to customers via their</text>
<text text-anchor="start" x="604.26" y="-444.1" font-family="Helvetica,sans-Serif" font-size="14.00" fill="#c2f0c2">mobile device.</text>
</g>
<!-- customer -->
<g id="node5" class="node">
<title>customer</title>
<polygon fill="#0284c7" stroke="#2563eb" stroke-width="0" points="814.3,-907.6 483.7,-907.6 483.7,-727.6 814.3,-727.6 814.3,-907.6"/>
<text text-anchor="start" x="524.49" y="-830.4" font-family="Helvetica,sans-Serif" font-size="20.00" fill="#f0f9ff">Personal Banking Customer</text>
<text text-anchor="start" x="514.76" y="-806.8" font-family="Helvetica,sans-Serif" font-size="14.00" fill="#b6ecf7">A customer of the bank, with personal bank</text>
<text text-anchor="start" x="619.04" y="-790" font-family="Helvetica,sans-Serif" font-size="14.00" fill="#b6ecf7">accounts.</text>
</g>
<!-- mobileapp&#45;&gt;signincontroller -->
<g id="edge1" class="edge">
<title>mobileapp&#45;&gt;signincontroller</title>
<path fill="none" stroke="#6e6e6e" stroke-width="2" stroke-dasharray="5,2" d="M535.33,-399.99C479.7,-356.53 412.64,-304.13 355.73,-259.67"/>
<polygon fill="#6e6e6e" stroke="#6e6e6e" stroke-width="2" points="358.01,-257.01 347.98,-253.61 353.7,-262.53 358.01,-257.01"/>
<text text-anchor="start" x="481" y="-339.1" font-family="Helvetica,sans-Serif" font-size="13.00" fill="#c6c6c6">Makes API calls to</text>
<text text-anchor="start" x="481" y="-323.5" font-family="Helvetica,sans-Serif" font-size="13.00" fill="#c6c6c6">[JSON/HTTPS]</text>
</g>
<!-- mobileapp&#45;&gt;accountssummarycontroller -->
<g id="edge2" class="edge">
<title>mobileapp&#45;&gt;accountssummarycontroller</title>
<path fill="none" stroke="#6e6e6e" stroke-width="2" stroke-dasharray="5,2" d="M649,-400.2C649,-358.36 649,-308.2 649,-264.8"/>
<polygon fill="#6e6e6e" stroke="#6e6e6e" stroke-width="2" points="652.5,-264.89 649,-254.89 645.5,-264.89 652.5,-264.89"/>
<text text-anchor="start" x="659" y="-339.1" font-family="Helvetica,sans-Serif" font-size="13.00" fill="#c6c6c6">Makes API calls to</text>
<text text-anchor="start" x="659" y="-323.5" font-family="Helvetica,sans-Serif" font-size="13.00" fill="#c6c6c6">[JSON/HTTPS]</text>
</g>
<!-- mobileapp&#45;&gt;resetpasswordcontroller -->
<g id="edge3" class="edge">
<title>mobileapp&#45;&gt;resetpasswordcontroller</title>
<path fill="none" stroke="#6e6e6e" stroke-width="2" stroke-dasharray="5,2" d="M764.58,-399.99C821.14,-356.53 889.33,-304.13 947.19,-259.67"/>
<polygon fill="#6e6e6e" stroke="#6e6e6e" stroke-width="2" points="949.3,-262.46 955.1,-253.59 945.04,-256.91 949.3,-262.46"/>
<text text-anchor="start" x="883" y="-339.1" font-family="Helvetica,sans-Serif" font-size="13.00" fill="#c6c6c6">Makes API calls to</text>
<text text-anchor="start" x="883" y="-323.5" font-family="Helvetica,sans-Serif" font-size="13.00" fill="#c6c6c6">[JSON/HTTPS]</text>
</g>
<!-- customer&#45;&gt;mobileapp -->
<g id="edge4" class="edge">
<title>customer&#45;&gt;mobileapp</title>
<path fill="none" stroke="#6e6e6e" stroke-width="2" stroke-dasharray="5,2" d="M649,-728C649,-686.16 649,-636 649,-592.6"/>
<polygon fill="#6e6e6e" stroke="#6e6e6e" stroke-width="2" points="652.5,-592.69 649,-582.69 645.5,-592.69 652.5,-592.69"/>
<text text-anchor="start" x="659" y="-666.9" font-family="Helvetica,sans-Serif" font-size="13.00" fill="#c6c6c6">Views account balances, and makes</text>
<text text-anchor="start" x="659" y="-651.3" font-family="Helvetica,sans-Serif" font-size="13.00" fill="#c6c6c6">payments using</text>
</g>
</g>
</svg>
`;default:throw new Error("Unknown viewId: "+e)}}function Wn({viewId:e}){const n=Zn(e);return L.jsxs(xe,{direction:"horizontal",autoSaveId:"viewAsDot",children:[L.jsx(le,{minSizePixels:100,children:L.jsxs(fe,{scrollbars:"both",children:[L.jsx(Y,{asChild:!0,display:"block",p:"2",style:{whiteSpace:"pre",minHeight:"100%"},children:L.jsx(Fe,{variant:"soft",autoFocus:!0,children:n})}),L.jsx(ve,{text:n})]})}),L.jsx(Pe,{style:{width:10}}),L.jsx(le,{minSizePixels:100,children:L.jsx(fe,{scrollbars:"both",children:L.jsx(Y,{py:"2",style:{overflow:"scroll",overscrollBehavior:"none"},children:L.jsx(Y,{asChild:!0,position:"relative",className:"svg-container",children:L.jsx("div",{dangerouslySetInnerHTML:{__html:_n(e)}})})})})})]})}function Jn(e){switch(e){case"index":return`---
...
graph TB
  ...
  Customer -. "Views account balances, and makes payments using" .-> BigbankInternetBankingSystem.MobileApp
  BigbankInternetBankingSystem.MobileApp -. "Makes API calls to\r [JSON/HTTPS]" .-> BigbankInternetBankingSystem.ApiApplication.ResetPasswordController
  BigbankInternetBankingSystem.MobileApp -. "Makes API calls to\r [JSON/HTTPS]" .-> BigbankInternetBankingSystem.ApiApplication.AccountsSummaryController
  BigbankInternetBankingSystem.MobileApp -. "Makes API calls to\r [JSON/HTTPS]" .-> BigbankInternetBankingSystem.ApiApplication.SigninController
`;default:throw new Error("Unknown viewId: "+e)}}const Un=async(e,n)=>{const{default:t}=await pn(()=>import("https://cdn.jsdelivr.net/npm/mermaid@10/dist/mermaid.esm.min.mjs"),__vite__mapDeps([]));t.initialize({theme:"dark"});const{svg:i}=await t.render(e,n);return i};function jn({viewId:e}){const n=Jn(e),[t,{execute:i}]=je(Un,null);return De.useEffect(()=>{i(e,n)},[n]),L.jsxs(xe,{direction:"horizontal",autoSaveId:"ViewAsD2",children:[L.jsx(le,{minSizePixels:100,children:L.jsxs(fe,{scrollbars:"both",children:[L.jsx(Y,{asChild:!0,display:"block",p:"2",style:{whiteSpace:"pre",minHeight:"100%"},children:L.jsx(Fe,{variant:"soft",autoFocus:!0,children:n})}),L.jsx(ve,{text:n})]})}),L.jsx(Pe,{style:{width:10}}),L.jsx(le,{minSizePixels:100,children:L.jsx(fe,{scrollbars:"both",children:t.result&&L.jsx(Y,{grow:"1",asChild:!0,position:"relative",className:"svg-container",children:L.jsx("div",{dangerouslySetInnerHTML:{__html:t.result}})})})})]})}function Yn({viewId:e,viewMode:n}){return L.jsx(Rn,{asChild:!0,position:"fixed",inset:"0",pt:"8",pl:"8",pr:"2",align:"stretch",direction:"column",children:L.jsxs($.Root,{value:n,onValueChange:t=>t!==n&&Dn({mode:t}),children:[L.jsx(Y,{asChild:!0,shrink:"0",grow:"0",children:L.jsxs($.List,{children:[L.jsx($.Trigger,{value:"react",children:"React"}),L.jsx($.Trigger,{value:"dot",children:"Graphviz"}),L.jsx($.Trigger,{value:"mmd",children:"Mermaid"}),L.jsx($.Trigger,{value:"d2",children:"D2"})]})}),L.jsxs(Y,{p:"2",className:On.otherFormats,position:"relative",children:[L.jsx($.Content,{value:"react",children:""}),L.jsx($.Content,{value:"dot",children:L.jsx(Wn,{viewId:e})}),L.jsx($.Content,{value:"mmd",children:L.jsx(jn,{viewId:e})}),L.jsx($.Content,{value:"d2",children:L.jsx(Vn,{viewId:e})})]})]})})}export{Yn as default};
